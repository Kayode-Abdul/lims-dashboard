...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.globaldiagnostics.lims'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'lims'),

    /**
     * The author of your application.
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Global Diagnostics'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright © ' . date('Y') . ' Global Diagnostics'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Laboratory Information Management System - Desktop Edition'),
