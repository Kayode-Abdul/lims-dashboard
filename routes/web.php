...
//******* This is the old gate code I commented out when trying to fix the caching */
// uncomment in production
// use Illuminate\Support\Facades\Gate;

// // Force Super Admin bypass regardless of caching
...
Route::middleware('auth')->group(function () {
    ...
    // Super Admin Routes
    Route::middleware('can:access-super-admin')->prefix('super-admin')->name('super-admin.')->group(
        function () {
    ...
    Route::middleware('lab.subscription')->group(
        function () {
            ...
            Route::get('test-results/pdf/{orderNumber}', [\App\Http\Controllers\TestResultController::class, 'downloadPdf'])->name('test-results.pdf')->where('orderNumber', '.*');
            Route::get('test-results/zip/{orderNumber}', [\App\Http\Controllers\TestResultController::class, 'generateZip'])->name('test-results.zip')->where('orderNumber', '.*');
